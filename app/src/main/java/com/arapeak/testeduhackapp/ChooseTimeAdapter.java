...
public class ChooseTimeAdapter extends RecyclerView.Adapter<ChooseTimeAdapter.CategoryViewHolder> {
    ...
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        ...
        View view = layoutInflater.inflate(R.layout.item_choose_time_layout, parent, false);
